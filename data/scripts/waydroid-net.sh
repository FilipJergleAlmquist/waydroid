...
USE_LXC_BRIDGE="true"
LXC_BRIDGE="${vnic}"
LXC_BRIDGE_MAC="00:16:3e:00:00:$(printf '%02x' $SESSION_ID)"
LXC_NETMASK="255.255.255.0"
LXC_ADDR="192.168.$((100 + SESSION_ID)).1"
LXC_NETWORK="192.168.$((100 + SESSION_ID)).0/24"
LXC_DHCP_RANGE="192.168.$((100 + SESSION_ID)).2,192.168.$((100 + SESSION_ID)).254"
LXC_DHCP_MAX="253"
LXC_DHCP_CONFILE=""
LXC_DHCP_PING="true"
LXC_DOMAIN=""
